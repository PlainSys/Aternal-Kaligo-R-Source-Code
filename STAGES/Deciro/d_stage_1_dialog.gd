...
func _on_dia_8_timeout():
	$dia8.stop()
	$dia9.start()
	$CanvasLayer/dialog/dialog9.hide()
	$CanvasLayer/dialog/dialog10.show()
	$CanvasLayer/dialog/pen.hide()
	$CanvasLayer/dialog/deciro2.show()

func _on_dia_9_timeout():
	get_tree().change_scene_to_file("res://STAGES/Deciro/d_stage_1_boss.tscn")
